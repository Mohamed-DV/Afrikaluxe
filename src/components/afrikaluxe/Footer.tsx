    ...
    <footer className="relative border-t border-border/60 bg-[oklch(0.08_0.008_60)] py-12">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 md:flex-row">
        <div className="flex items-center gap-3">
          <span className="grid h-10 w-10 place-items-center rounded-full bg-gradient-gold text-primary-foreground font-display text-lg shadow-gold">
            A
          </span>
          <div>
            ...
            <div className="text-xs text-muted-foreground">Le luxe accessible, partout en Afrique.</div>
          </div>
        </div>
